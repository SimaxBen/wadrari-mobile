...
try {
  ...
  console.warn('Failed to import Supabase service:', error);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.mainContainer}>
        ...
        <View style={styles.profileContainer}>
          <Text style={styles.profileTitle}>Profile (From Supabase Database)</Text>
        ...
        <View style={styles.statusContainer}>
          ...
          <Text style={styles.statusGood}>✅ Password Hash Verified</Text>
        </View>
